...
public class AuthServiceTests
{
    ...
    public AuthServiceTests()
    {
        ...
        _userRepositoryMock
            .Setup(r => r.RecordLoginFailureAsync(It.IsAny<User>(), It.IsAny<CancellationToken>()))
            .Returns(Task.CompletedTask);
        _userRepositoryMock
            .Setup(r => r.RecordLoginSuccessAsync(It.IsAny<User>(), It.IsAny<CancellationToken>()))
            .Returns(Task.CompletedTask);
    ...
    public async Task LoginAsync_WithIncorrectPassword_ReturnNull()
    {
        ...
        _userRepositoryMock.Verify(r => r.RecordLoginFailureAsync(_fakeUser, It.IsAny<CancellationToken>()), Times.Once);
        _userRepositoryMock.Verify(r => r.RecordLoginSuccessAsync(It.IsAny<User>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task LoginAsync_WithCorrectCredentials_ReturnToken()
    {
        ...
        _userRepositoryMock.Verify(r => r.RecordLoginSuccessAsync(_fakeUser, It.IsAny<CancellationToken>()), Times.Once);
        _userRepositoryMock.Verify(r => r.RecordLoginFailureAsync(It.IsAny<User>(), It.IsAny<CancellationToken>()), Times.Never);
    }

    [Fact]
    public async Task LoginAsync_WhenLockoutActive_ReturnsNullWithoutVerifyingPassword()
    {
        ...
        _userRepositoryMock.Setup(repo => repo.GetByEmailAsync("admin@bb.com")).ReturnsAsync(lockedUser);
